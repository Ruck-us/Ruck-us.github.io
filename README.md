...
## FOOTER
   ...
   ### SEQUENCE
   - FILL IN BODY OF HTML SITE
   - FILL IN TEXT WITH NONESENSE
   - USE INSPECT FEATURE TO VIEW AND TWEAK INFORMATION
   - CSS
   - DON'T TAKE TOO LONG, I DON'T CARE ABOUT THIS SITE. 
   - UTILIZE EXISTING CODE, NO NEED TO REINVENT THE WEHEEL

   #### RESOURCES
    - BOOSTRAP
    - W3
    - use generic it information for the profile as Mr. Profile
